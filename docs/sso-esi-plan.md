...
1. Add dependencies: `serde`, `serde_json`, `reqwest`, `url`, `rand`, and PKCE helpers. The app stores the EVE Client ID in its config and uses `http://127.0.0.1:18421/callback` as the default redirect URI.
